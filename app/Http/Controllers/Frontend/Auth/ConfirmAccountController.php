...
class ConfirmAccountController extends Controller
{
    ...
    {
        $username = $this->user->confirm($token);

        return redirect()->route('frontend.auth.login', ['username' => $username])->withFlashSuccess(__('exceptions.frontend.auth.confirmation.success'));
    }
