...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | These values are used by the DomainMiddleware.
    |
    */

	'base_url' => env('APP_BASE_URL', parse_url(env('APP_URL', 'http://localhost'), PHP_URL_HOST)),

	'force_domain_id' => env('FORCE_DOMAIN_ID', null),

	'fallback_domain_id' => env('FALLBACK_DOMAIN_ID', null),
    ...
    */
    ...
    'aliases' => [
		...
		'MorphPlaylist' => App\Models\AcPlaylist::class,

		'Twitch' => App\Services\Twitch\TwitchFacade::class,
    ],
