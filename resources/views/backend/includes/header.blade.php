<header class="app-header navbar">
    ...
    <ul class="nav navbar-nav d-md-down-none">
        <li class="nav-item px-3">
            <a class="nav-link" href="{{ route('frontend.index') }}"><i class="fas fa-home"></i>&nbsp;&nbsp;Return to website</a>
        </li>
        {{--
        <li class="nav-item px-3">
            <a class="nav-link" href="{{ route('frontend.learn') }}"><strong></strong></a>
        </li>
        --}}
    ...
    <ul class="nav navbar-nav ml-auto" style="margin-right: 18px;">
    {{--
